                                            ...
                                            <div class="col-12">
                                                <div class="card card-primary card-outline">
                                                    <div class="card-body box-profile">
                                                      ...
                                                      <p>Mengerjakan 3 halaman website HTML, menyatukan semua halaman website dan membuat form yang terintegrasi dengan bahasa pemrograman PHP</p>
                                                    </div>
                                                    <!-- /.card-body -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="card card-primary card-outline">
                                                    <div class="card-body box-profile">
                                                      ...
                                                      <p>Mengerjakan 2 halaman website HTML, dan mengedit video presentasi</p>
                                                    </div>
                                                    <!-- /.card-body -->
                                                </div>
                                            </div>
