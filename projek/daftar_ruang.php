...
<head>
  ...
  <title>Daftar Ruangan - eRuang</title>
          ...
          >
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                ?>
                <li class="nav-item">
                  <a href="detail_ruangan.php?nama_ruangan=<?= $ruangan[$i][0] ?>" class="nav-link">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="text-center">Daftar Ruang</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <button class="btn btn-primary mb-3"><a href="tambah_ruangan.php" style="color: #fff;">Tambah</a></button>
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $ruangan[$i][3] ?></td>
                        <td>
                          <a href="php/delete.php?nama_ruangan=<?= $ruangan[$i][0] ?>" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
                      <?php } 
                          } else {?>
